...
var TshirtData: [Tshirt] = [
    Tshirt(
         ...
         mainImage: "kisuneLogoTshirt",
         coodi1: "kisuneLogoCoodi1",
         coodi2: "kisuneLogoCoodi2",
         coodi3: "kisuneLogoCoodi3"),
    
    Tshirt(
        title: "아미",
        description: "하트와 알파벳 A의 로고, /n'AMI'는 프랑스어로 '친구'라는 의미를 /n가지고 있어요. 친구란느 이름처럼 친구들이 /n입고 싶어하는, 과한 느낌을 지양하고 /n자연스러운 디자인의 스타일을 추구합니다.",
